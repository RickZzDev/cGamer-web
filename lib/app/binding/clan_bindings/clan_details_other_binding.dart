...
class ClanDetailOtherBinding implements Bindings {
@override
void dependencies() {
  Requester requester = Requester();
  ClanDetailsProvider provider = ClanDetailsProvider(requester: requester);
  ClanDetailsRepository repository = ClanDetailsRepository(provider: provider);

  Get.lazyPut<ClanDetailsOtherController>(() => ClanDetailsOtherController(
