...
class PasswordTransferExtern extends StatelessWidget {
  final TransferExternPasswordController _controller =
      Get.find<TransferExternPasswordController>();
              ...
              child: Column(
                ...
                children: [
                  CustomRichText(
                    ...
                    customText:
                        "informe sua senha para confirmarmos a transferência",
                    // customFirst: true,
                  ),
                  SizedBox(
                    height: 16,
