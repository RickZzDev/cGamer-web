...
class ClanSeasonTitle extends StatelessWidget {
  ClanSeasonTitle({required this.controller});
        ...
        child: Column(children: [
          ...
          CountdownTimer(
            endTime: controller.getTimeLeft(
                controller.rankingModelResult.value.season?.dateFinish),
          ...
          Row(
            ...
            children: [
              Text(
                ' 1.º ${controller.rankingModelResult.value.season?.prize?[0]} ',
                style: textStyle.copyWith(
                    fontSize: 16,
                    color: primaryColor,
                    fontWeight: FontWeight.bold),
          ...
          Row(
            ...
            children: [
              Text(
                ' 2.º ${controller.rankingModelResult.value.season?.prize?[1]} ',
                style: textStyle.copyWith(
                    fontSize: 16,
                    color: primaryColor,
                    fontWeight: FontWeight.bold),
          ...
          Row(
            ...
            children: [
              Text(
                ' 3.º ${controller.rankingModelResult.value.season?.prize?[2]} ',
                style: textStyle.copyWith(
                    fontSize: 16,
                    color: primaryColor,
                    fontWeight: FontWeight.bold),
          ...
          SizedBox(height: 4),
          Text(
            'Premiação para cada membro do clã vencedor!',
