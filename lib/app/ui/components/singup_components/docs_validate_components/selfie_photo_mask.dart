...
class CustomCameraFocus {
  ...
  static Widget rectangle({required Color color}) =>
      _FocusRectangle(color: color);
  static Widget circle({required Color color}) => _FocusCircle(
        color: color,
      );
  static Widget square({required Color color}) => _FocusSquare(
        color: color,
      );
}
...
class _FocusSquare extends StatelessWidget {
  ...
  const _FocusSquare({Key? key, required this.color}) : super(key: key);
  @override
...
class _FocusRectangle extends StatelessWidget {
  ...
  const _FocusRectangle({Key? key, required this.color}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return IgnorePointer(
      child: ClipPath(
...
class _FocusCircle extends StatelessWidget {
  ...
  const _FocusCircle({Key? key, required this.color}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return IgnorePointer(
      child: ClipPath(
